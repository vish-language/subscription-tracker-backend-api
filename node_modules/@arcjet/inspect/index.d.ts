import type { ArcjetRuleResult } from "@arcjet/protocol";
/**
 ...
 */
export declare function isSpoofedBot(result: ArcjetRuleResult): boolean | undefined;
/**
 ...
 *   `undefined` if the rule result was non-bot or `DRY_RUN`.
 */
export declare function isVerifiedBot(result: ArcjetRuleResult): boolean | undefined;
/**
 ...
 *   `undefined` if the rule result was non-bot or `DRY_RUN`.
 */
export declare function isMissingUserAgent(result: ArcjetRuleResult): boolean | undefined;
